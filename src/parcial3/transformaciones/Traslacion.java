...
public class Traslacion extends JFrame implements KeyListener {
    public static void main(String[] args) {
        Traslacion proyeccion = new Traslacion();
    ...
    public void keyPressed(KeyEvent e) {
        ...
        case KeyEvent.VK_A:
            ...
            // this.cubo.rotarX(isPressingShift ? cubo.getAngulo()+5: cubo.getAngulo()-5,
            // plano);
            // this.cubo.trasladar(isPressingShift ? 5 : -5, 0, 0);
            this.x1+= isPressingShift ? 5 : -5;
            this.x2+= isPressingShift ? 5 : -5;
            return;
        case KeyEvent.VK_S:
            System.out.println("pressing a");
            this.y1 += isPressingShift ? 5 : -5;;
            this.y2 += isPressingShift ? 5 : -5;;

            return;
        case KeyEvent.VK_D:
            System.out.println("pressing a");
            this.z1 += isPressingShift ? 5 : -5;;
            this.z2 += isPressingShift ? 5 : -5;;
            return;
        }
    }
